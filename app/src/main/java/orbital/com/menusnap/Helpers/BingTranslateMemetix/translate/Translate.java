 ...
 */
package orbital.com.menusnap.Helpers.BingTranslateMemetix.translate;


import java.net.URL;
import java.net.URLEncoder;

import orbital.com.menusnap.Helpers.BingTranslateMemetix.MicrosoftTranslatorAPI;
import orbital.com.menusnap.Helpers.BingTranslateMemetix.language.Language;
...
public final class Translate extends MicrosoftTranslatorAPI {
    ...
    /**
     * Accepts a String as the target language instead of the enum values for Language.
     * @param text
     * @param to
     * @return
     * @throws Exception
    ...
    public static String execute(final String text, final Language from, final String to) throws Exception {
        //Run the basic service validations first
        validateServiceState(text);
        final String params =
                (apiKey != null ? PARAM_APP_ID + URLEncoder.encode(apiKey,ENCODING) : "")
